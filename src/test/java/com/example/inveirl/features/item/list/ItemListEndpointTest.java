...
class ItemListEndpointTest {
    private static final String URL = "/items";

    private static final ItemListService service = mock(ItemListService.class);
    private static final Validator validator = mock(Validator.class);

    private static final MockMvc mockMvc = MockMvcBuilders.standaloneSetup(new ItemListEndpoint(service))
