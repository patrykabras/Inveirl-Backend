...
class UserSignUpEndpointTest {
    ...
    private static final UserSignUpService service = mock(UserSignUpService.class);
    private static final Validator validator = mock(Validator.class);

    private static final MockMvc mockMvc = MockMvcBuilders.standaloneSetup(new UserSignUpEndpoint(service))
